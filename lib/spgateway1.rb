class Spgateway1
  ...
  def initialize(payment)
    @payment = payment
    self.merchant_id = "MS33487888"
    self.hash_key = "TYiU1DmujbmURuMe0Htc6sep2Er4xD0L"
    self.hash_iv = "JhTNuxOHK7jDcZQQ"
  ...
  def generate_form_data(return_url)
    spgateway_data = {
      ...
      Amt: @payment.amount,
      ItemDesc: @payment.rail_order.name,
      ReturnURL: return_url,
      Email: @payment.rail_order.user.email,
      LoginType: 0
    }
